...
oxwm.autostart("xwallpaper --zoom ~/nixos-dotfiles/config/bg/nixbg.png")
oxwm.autostart("picom --config /home/alan/nixos-dotfiles/config/picom/picom.conf")
